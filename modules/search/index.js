...
async function bootstrap(context) {
    ...
    try {
        ...
        // ==========================================
        // PUBLIC ENDPOINTS (Subscription-Gated)
        // ==========================================
        ...
        /**
         * Attribute Clause Source resolver (for widgets)
         *
         * Goal:
         * - Given (attribute_code, clause_name), find ALL categories that "have" that attribute via inheritance
         * - Exclude any categories listed in clause.excluded_category_ids
         * - Pick one category at random
         * - Build a "pretty" branded slug + title
         * - Return products for that category filtered by the clause
         *
         * Query params:
         * - attribute_code (required)
         * - clause (required) clause name
        ...
        router.get('/attribute-clause/random-category', optionalAuth, asyncHandler(async (req, res) => {
            ...
            // Get all categories that "inherit" this attribute (direct + inherited), and are active
            // Inheritance rule: if parent has attribute, descendants inherit it.
            ...
            // Pretty slug format matches SearchService.resolveBrandedSlug() convention (prefix + cat.slug + suffix)
            const prettySlug = slugify(`${prefix}${picked.slug || ''}${suffix}`);
            // Storefront pretty URLs are resolved via `storefront-web/app/[slug]/page.js`
        ...
        // Filter schema for storefront search UI (attributes + categories)
        // PUBLIC (subscription-gated) - helps build attribute-specific filters
        ...
        // ==========================================
        // MANUAL INDEXING ENDPOINTS (Admin)
        // ==========================================
